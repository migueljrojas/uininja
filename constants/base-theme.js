...
export default {
  ...
  buttonBase: {
    ...
    'padding-xs': `${vars.baseHeight / 3}px`,
    'padding-sm': `${vars.baseHeight / 2.5}px`,
    'padding-md': `${vars.baseHeight / 2}px`,
    'padding-lg': `${vars.baseHeight / 1.5}px`,
    'padding-xl': `${vars.baseHeight}px`,
